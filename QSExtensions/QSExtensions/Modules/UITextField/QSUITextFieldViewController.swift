//
//  QSUITextFieldViewController.swift
//  QSExtensions
//
...
class QSUITextFieldViewController: UIViewController {
    ...
    private lazy var limitDecimalTF: UITextField = {
        let tf = UITextField.init()
        tf.borderStyle = .roundedRect
        return tf
    }()
    ...
    private lazy var isAllowEditTF: UITextField = {
        let tf = UITextField.init()
        tf.borderStyle = .roundedRect
