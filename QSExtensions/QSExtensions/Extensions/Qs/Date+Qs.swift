...
public extension Date {
    ...
    func qs_toString(format: String = "yyyy-MM-dd HH:mm:ss") -> String {
    ...
    /// 转换为时间戳（毫秒）
    func qs_toTimestamp() -> TimeInterval {
    ...
    /// - Parameters:
    ///   - date: 要与self比较的时间
    func qs_intervalSince(date: Date) -> (days: Int, hours: Int, minutes: Int, seconds: Int) {
        // 计算时间间隔（单位是秒）
    ...
    /// 与当前的日期差
    func qs_intervalSinceNow() -> (days: Int, hours: Int, minutes: Int, seconds: Int) {
    ...
    func qs_theDateAfter(_ days: Int) -> Date? {
